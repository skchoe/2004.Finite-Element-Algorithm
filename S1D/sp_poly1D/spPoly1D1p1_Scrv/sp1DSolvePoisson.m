...
%
function [xvec, yvec_apx, vBL, vBR] = sp1DSolvePoisson(BdyType, left, right, dxvec, pvec, vBL, vBR)
    ...
    for el = 1:N
        ...
        if BdyType == 'DD'
            [fzs, vBL, vBR] = spEvalUserFunctionsDD(left, right, xiz, vBL, vBR);
        elseif BdyType == 'DN'
            [fzs, vBL, vBR] = spEvalUserFunctionsDN(left, right, xiz, vBL, vBR);
        else
        end
