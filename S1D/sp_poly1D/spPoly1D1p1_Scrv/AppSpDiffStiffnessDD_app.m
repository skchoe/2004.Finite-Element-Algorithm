...
p=9;
% left = 0; right = 1; dxvec = [.3, .4, .3]'; pvec = p*[2, 1, 1]'; vdl = 999; vdr = 999;
% left = 0; right = 1; dxvec = [.3, .2, .2, .3]'; pvec = p*[1, 2, 2, 1]'; vdl = 999; vdr = 999;
left = 0; right = 1; dxvec = [.1, .2, .2, .2, .2, .1]'; pvec = p*[1, 1, 1, 1, 1, 1]'; vdl = 999; vdr = 999;
