%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function spPlotResult(intervals, left, right, alpha, beta, dxvec, pvec, bdleft, bdright, ug_hat, map, figno)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
    ...
    [yv, fvec, vLDB, vRNB] = spEvalUserFunctions(left, right, xvec, intervals+1, bdleft, bdright)
