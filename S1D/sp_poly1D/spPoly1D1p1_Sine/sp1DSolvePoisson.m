...
%
function [xvec, yvec_apx, vBL, vBR] = sp1DSolvePoisson(BdyType, left, right, dxvec, pvec, vdl, vdr)
    ...
    for el = 1:N
        ...
        if BdyType == 'DD'
            [fzs, vBL, vBR] = spEvalUserFunctionsDD(left, right, xiz, vdl, vdr);
        elseif BdyType == 'DN'
            [fzs, vBL, vBR] = spEvalUserFunctionsDN(left, right, xiz, vdl, vdr);
        else
        end
