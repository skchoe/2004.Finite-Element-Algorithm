%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function spPlotResult(intervals, left, right, alpha, beta, dxvec, pvec, ug_hat, map, figno)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function spPlotResult(intervals, left, right, alpha, beta, dxvec, pvec, Lg, ug_hat, map, figno)
