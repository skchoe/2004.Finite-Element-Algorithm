...
for ip = NH_order_start : NH_order
  ...
  for j = 2:Ndiv
    dxvec_h = [unit_len; dxvec_h ];
    pvec_h1 = [NP_order_init + Fst; pvec_h1];
  end

  max_err_h1 = sp1DSolvePoisson('DD', left, right, dxvec_h, pvec_h1, 999, 999);
...
for ip = NH_order_start : NH_order
  ...
  for j = 2:Ndiv
    dxvec_h = [unit_len;dxvec_h];
    pvec_h2 = [NP_order_init + Snd;pvec_h2];
  end

  max_err_h2 = sp1DSolvePoisson('DD', left, right, dxvec_h, pvec_h2, 999, 999);
...
for ip = NH_order_start : NH_order
  ...
  max_err_h3 = sp1DSolvePoisson('DD', left, right, dxvec_h, pvec_h3, 999, 999);
...
figure(2);
  ...
  loglog(Herr_dom1, Herr_vec1, 'o-','markersize',5, 'linewidth', 2); hold on;
