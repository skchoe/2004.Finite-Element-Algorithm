%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [uvec, fvec, vLDB, vRNB] = spEvalUserFunctionsDN(left, right, domvec, Nvec, vdl, vnr)
% alphas: array of coefficient from order 0 to Nalpha
% crv_dom: vector of domain
% Nsamp:size of crv_dom
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [uvec, fvec, vLDB, vRNB] = spEvalUserFunctionsDN(left, right, domvec, Ndomvec, vdl, vnr)
%   %------------------------------------------------------------------------
