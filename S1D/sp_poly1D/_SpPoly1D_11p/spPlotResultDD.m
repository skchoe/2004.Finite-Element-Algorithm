...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function max_error = spPlotResultDD(intervals, left, right, alpha, beta, dxvec, pvec, bdleft, bdright, Lg, ug_hat, map, figno)
...
%
    ...
    [yv, fvec, vLDB, vRDB] = spEvalUserFunctionsDD(left, right, xvec, intervals+1, bdleft, bdright);
