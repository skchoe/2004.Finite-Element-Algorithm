...
function [xvec, yvec, zMat_apx, vBL, vBR] = ANN2DSolvePoisson(BdyType, left, right, dxvec, pvec, Nth, vecBL, vecBR)
...
%   Boundary Condition Processing
    [Mg, Fg] = applyBdy2GMat(BdyType, left, right, Ndof, pvec, Nth, Mg, Fg, vecBL, vecBR);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Mg, Fg] = applyBdy2GMat(BdyType, left, right, Ndof, pvec, Nth, Mg, Fg, vecBL, vecBR)
    ...
    for k = 1:Nth
        ...
        [Mlg, Flg] = applyBdy2LMat(BdyType, left, right, Ndof, Mlg, Flg, vecBL(k, 1), vecBR(k, 1));
...
function [Mlg, Flg] = applyBdy2LMat(BdyType, left, right, Ndof, Mlg, Flg, vBL, vBR)
