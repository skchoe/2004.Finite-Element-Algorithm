...
function rMeshTrisect(NdmF, ElmF, BdyDF, BdyNF, IntNdF, BdyDPF, NdcondF)
...
%             end
            ...
            cx1 = xNdm(nd1, 2); cy1 = xNdm(nd1, 3);
            cx2 = xNdm(nd2, 2); cy2 = xNdm(nd2, 3);
            
            cdtmat1 = feUserConduct(cx1, cy1);
            cdtmat2 = feUserConduct(cx2, cy2);
            for im = 1:4 % [2x2] matrix form of conductivity
