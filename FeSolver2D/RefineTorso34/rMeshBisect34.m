...
function bis_spec = rMeshBisect34(NdmF, ElmF, BdyDF, BdyNF, IntNdF, BdyDPF, NdcondF, drawFlag)
...
bis_Nnd = size(NdMat, 1);
bis_Nelt = size(Elm, 1);
bis_NbdD = size(BdyD, 1);
bis_NbdN = size(BdyN, 1);
bis_NintN = size(IntNd, 1);

bis_spec = [bis_Nnd; bis_Nelt; bis_NbdD; bis_NbdN; bis_NintN];
