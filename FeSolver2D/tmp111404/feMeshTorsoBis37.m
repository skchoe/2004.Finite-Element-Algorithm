...
function [NdMat, Elm, BdyD, BdyN, IntNd, BdyDP, NdcondF] = ...
    feMeshTorsoBis37(NdmF, ElmF, BdyDF, BdyNF, IntNdF, BdyDPF, NdcondF, drawFlag)
    ...
    for j = 1:NuNdElt % 6
        ...
        elseif j <= 6
            ...
            if xNdm(gNd, 3) == 0
                ...
                xNdm(gNd, 1) = 0.5 * (tmpVec(nd1, 1) + tmpVec(nd2, 1));
...
% save oldtemp.mat NdMat Elm -ASCII
% % Coordinates
...
%     for i = 1:Nnd
%         str = num2str(i);
%         text(Xvec(1, i), Yvec(1, i), str, 'Color', [0.2 0 0.5], 'Fontsize', 10);
%     end
% 
%     hold on;
%     
